...
if( ! function_exists( 'reverie_enqueue_style' ) ) {
	function reverie_enqueue_style()
	{
		...
		// wp_register_style( 'reverie-foundation-stylesheet', get_stylesheet_directory_uri() . '/assets/css/app.css', array(), '' );

		// Register the main style
		wp_register_style( 'reverie-stylesheet', get_stylesheet_directory_uri() . '/assets/css/style.css', array(), '', 'all' );
